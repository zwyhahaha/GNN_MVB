#!/bin/bash
python pipeline.py --prob_name indset --psucceed 0.9 --heuristics 0.05 --robust 1 --upCut 1  --lowCut 1
python pipeline.py --prob_name setcover --psucceed 0.99999 --heuristics 0.05 --robust 1 --upCut 0  --lowCut 1
