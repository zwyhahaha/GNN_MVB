...
caffeinate -i nohup python pipeline.py --prob_name setcover --sample 0 --data_free 1 --robust 0 --psucceed_low 0.999 --psucceed_up 0.999 --tmvb 0.9999 --gap 0.01 --heuristics 1.0 --robust 0 --upCut 1 --lowCut 1 --ratio_involve 0 > output.log 2>&1 &