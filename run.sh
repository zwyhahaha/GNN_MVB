...
caffeinate -i nohup python pipeline.py --prob_name setcover --sample 0 --data_free 0 --robust 1 --fixratio 0.4 --ratio_involve 1 --ratio_low 0.6 --ratio_up 0.0 --psucceed_low 0.9999 --gap 0.001 --upCut 0 --lowCut 1 --heuristics 0.05 > output.log 2>&1 &
wait $!
