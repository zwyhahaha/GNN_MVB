...
caffeinate -i nohup python pipeline.py --prob_name setcover --sample 1 --data_free 0 --robust 1 --ratio_involve 0 --tmvb 0.99 --psucceed_low 0.9999 --gap 0.001 --upCut 0 --lowCut 1 --heuristics 0.05 > output.log 2>&1 &
wait $!
